#!/bin/bash
# DSA-DPO Training launch script for Gemma 2 9B
...
echo "Starting DSA-DPO training for Gemma 2 9B with hr_dsa_dpo_sft_pairs dataset..."
FORCE_TORCHRUN=1 llamafactory-cli train examples/train_lora/hr_dsa_dpo_gemma2_training.yaml
